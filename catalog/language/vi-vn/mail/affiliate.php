...
$_['text_service']        = 'Sau khi đăng nhập, bạn sẽ có thể tạo mã theo dõi, theo dõi các khoản hoa hồng và chỉnh sửa thông tin tài khoản của mình.';
$_['text_thanks']         = 'Cảm ơn,';
$_['text_new_affiliate']  = 'Cộng Tác Viên Mới';
$_['text_signup']         = 'Một cộng tác viên mới vừa đăng ký:';
